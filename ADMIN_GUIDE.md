...
- Make sure `python manage.py runserver 0.0.0.0:8000` is running
...
- Check that the API is accessible at `http://192.168.1.11:8000/api/properties/`
...
**Admin Panel**: http://localhost:8000/admin (or http://192.168.1.11:8000/admin)
